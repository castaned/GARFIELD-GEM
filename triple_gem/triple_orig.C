...
int main(int argc, char * argv[]) 
{
  ...
  const std::string efile = "/panfs/vol/HEP/GEM/ansys_input/v3650/pitch560/ELIST.lis";
  const std::string nfile = "/panfs/vol/HEP/GEM/ansys_input/v3650/pitch560/NLIST.lis";
  const std::string mfile = "/panfs/vol/HEP/GEM/ansys_input/v3650/pitch560/MPLIST.lis";
  const std::string sfile = "/panfs/vol/HEP/GEM/ansys_input/v3650/pitch560/PRNSOL.lis";
  ...
  {     
    ...
    out<<ne<<"  "<<AllElectron<<"  "<<SumHalfStrip<<"  "<<Sum1Strip<<"  "<<Sum2Strip<<endl;
  }
